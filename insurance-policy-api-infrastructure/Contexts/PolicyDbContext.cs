    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<PolicyEntity>(entity =>
        {
            ...
            entity.Property(e => e.Cpf)
                .HasMaxLength(12)
                .HasColumnName("cpf");
            entity.Property(e => e.DataAlteracaoRegistro).HasColumnName("data_alteracao_registro");
            entity.Property(e => e.DataCriacaoRegistro).HasColumnName("data_criacao_registro");
            ...
            entity.Property(e => e.UsuarioAlteracaoRegistro).HasColumnName("usuario_alteracao_registro");
            entity.Property(e => e.UsuarioCriacaoRegistro).HasColumnName("usuario_criacao_registro");
        });
        ...
        modelBuilder.Entity<InstallmentEntity>(entity =>
        {
            ...
            entity.Property(e => e.DataPago).HasColumnName("data_pago");
            ...
            entity.HasOne(d => d.Apolice).WithMany(p => p.Parcelas)
